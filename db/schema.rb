...
ActiveRecord::Schema.define(version: 20180203171758) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["coin_id"], name: "index_events_on_coin_id", using: :btree
    t.index ["exchange_id"], name: "index_events_on_exchange_id", using: :btree
  end
